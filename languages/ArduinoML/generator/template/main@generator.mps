  ...
  <node concept="13MO4I" id="2lnn8aaCrLt">
    ...
    <node concept="9aQIb" id="2lnn8aaCskM" role="13RCb5">
      <node concept="3clFbS" id="2lnn8aaCskT" role="9aQI4">
        <node concept="3clFbF" id="2lnn8aaCskR" role="3cqZAp">
          <node concept="2OqwBi" id="2lnn8aaCskO" role="3clFbG">
            <node concept="10M0yZ" id="2lnn8aaCskP" role="2Oq$k0">
              <ref role="1PxDUh" to="wyt6:~System" resolve="System" />
              <ref role="3cqZAo" to="wyt6:~System.out" resolve="out" />
            </node>
            <node concept="liA8E" id="2lnn8aaCskQ" role="2OqNvi">
              <ref role="37wK5l" to="guwi:~PrintStream.println(java.lang.String):void" resolve="println" />
              <node concept="Xl_RD" id="2lnn8aaCslr" role="37wK5m">
                <property role="Xl_RC" value="yolo" />
              </node>
            </node>
          </node>
        </node>
